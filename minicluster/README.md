...
--------------------------------------------------------------------------------
RESULT: [OK] PASSED: All 100 steps passed correctness check within 1.00% tolerance
--------------------------------------------------------------------------------
...
SLOW_WORKER: [OK] DETECTED
  Affected rank: 0
  Reason: Detected via throughput deviation

GRADIENT_SYNC_ANOMALY: [OK] DETECTED
  Affected rank: 0
  Reason: Detected via loss divergence

WORKER_TIMEOUT: [OK] DETECTED
  Affected rank: 0
...
**Output:**
```
[OK] Baseline 'stable_v1' saved successfully
```
...
Metric Comparisons:
--------------------------------------------------------------------------------
average_loss                     0.082000 -> 0.085200 (+4.15%)      [OK]
final_loss                       0.045000 -> 0.046800 (+4.00%)      [OK]
average_throughput_samples_per_sec 152.500000 -> 149.800000 (-1.77%) [OK]
...
**Test Coverage**:
- [OK] Single-process training completes with correct metrics
- [OK] Multi-process training (via single-worker wrapper) completes
- [OK] Correctness validator passes for identical runs
- [OK] Correctness validator fails when loss diverges beyond tolerance
- [OK] Fault injector detects slow worker via throughput
- [OK] Fault injector detects gradient anomaly via loss divergence
- [OK] Fault injector detects timeout via step mismatch
- [OK] Baseline save/load round-trips correctly
- [OK] Baseline comparison flags regressions
- [OK] CLI subcommands execute without errors

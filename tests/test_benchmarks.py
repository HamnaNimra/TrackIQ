...
class TestBatchingTradeoffBenchmark:
    ...
    def test_run_with_custom_parameters(self):
        ...
        benchmark = BatchingTradeoffBenchmark()
        results = benchmark.run(batch_sizes=[1, 4], num_images=2000, base_overhead=0.02, time_per_image=0.01)
    ...
    def test_latency_increases_with_batch_size(self):
        ...
        benchmark = BatchingTradeoffBenchmark()
        results = benchmark.run(batch_sizes=[1, 4, 16], base_overhead=0.01, time_per_image=0.005)
...
class TestLLMLatencyBenchmark:
    ...
    def test_run_with_custom_parameters(self):
        ...
        benchmark = LLMLatencyBenchmark()
        results = benchmark.run(prompt_tokens=256, output_tokens=128, num_runs=5)

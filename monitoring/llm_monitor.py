...
class KVCacheAnalyzer:
    ...
    def calculate_kv_cache_size_per_token(self, batch_size=1):
        ...
        size_per_layer = batch_size * self.num_heads * self.head_size * self.bytes_per_element * 2  # K and V
    ...
    def monitor_inference(self, duration_seconds=30, sample_interval=1):
        ...
        print("{:>6} | {:>10} | {:>10} | {:>15}".format("Time", "Used (MB)", "Total (MB)", "Growth (MB/s)"))
        print("-" * 60)
...
def main():
    ...
    analyzer = KVCacheAnalyzer(num_layers=32, num_heads=32, head_size=128, max_seq_len=2048, precision="fp16")
